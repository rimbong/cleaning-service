...
/**
 * <pre>
 * PBox을 상속받아 구현한 PSession 클래스
 * </pre>
 */
@Component
@Qualifier("pSession")
public class PSession extends PBox {
	...
	/**
	 * <pre>
	 * HttpSession 객체의 데이터를 PBox 데이터로 Sync 한다.
	 * </pre>
	 * 
	 * @param
	 * @return
...
//	@SuppressWarnings("unchecked")
	private void syncSesstionToPBox() {
	...
	/**
	 * <pre>
	 * PBox 객체의 데이터를 HttpSession 데이터로 Sync 한다.
	 * </pre>
	 * 
	 * @param
	 * @return
	 */
	private void syncPBoxToSession() {
	...
	/**
	 * <pre>
	 * PBox 의 값을 오버라이딩 하여 입력받은 key, Value 값을 PBox에 셋팅하는 메소드
	 * </pre>
	 * 
	 * @param <E>
	 * @param key
	...
	/**
	 * <pre>
	 * PBox 의 값을 오버라이딩 하여 JSON 형식의 Data를 SBox 형태로 출력함.
	 * </pre>
	 * 
	 * @param jsonData
	...
	/**
	 * <pre>
	 * PSession 의 특정 key 값에 해당하는 객체를 삭제한다.
	 * </pre>
	 * 
	 * @param key
	 *            : 삭제할 key 값
