 ...
 * @version 1.0
 */
public class HttpProxyGetRequest {
    ...
    private HttpProxyGetRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public HttpProxyGetRequest build() {
            ...
            return new HttpProxyGetRequest(this);
        }
    }
    ...
    public static void doHttpGet(HttpProxyGetRequest request) throws IllegalArgumentException, IOException, Exception {
