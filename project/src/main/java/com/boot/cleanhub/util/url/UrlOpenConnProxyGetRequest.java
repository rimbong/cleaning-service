...
public class UrlOpenConnProxyGetRequest {
    ...
    private UrlOpenConnProxyGetRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UrlOpenConnProxyGetRequest build() {
            return new UrlOpenConnProxyGetRequest(this);
        }
    }
    ...
    public static void doHttpGet(UrlOpenConnProxyGetRequest request) throws Exception {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                //     인코딩 헤더를 위에서 relay 했으므로, 본문은 디코딩 없이 원본 바이트를 전달한다.
                ...
                try (InputStream errorStream = connection.getErrorStream()) {
                    if (errorStream != null) {
                        ...
                        System.err.println("Error Response: " + baos.toString("UTF-8"));
                    } else {
