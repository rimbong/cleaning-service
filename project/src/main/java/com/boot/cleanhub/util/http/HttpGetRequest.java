...
public class HttpGetRequest {
    ...
    private HttpGetRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public HttpGetRequest build() throws Exception{
    ...
    public static String doHttpGet(HttpGetRequest request) throws IllegalArgumentException, IOException, Exception {
