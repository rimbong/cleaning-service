...
public class HttpPostFileRequest {
    ...
    private HttpPostFileRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public HttpPostFileRequest build() {
            ...
            return new HttpPostFileRequest(this);
        }
    }
    ...
    public static void doHttpPost(HttpPostFileRequest request) throws IllegalArgumentException, IOException, Exception {
