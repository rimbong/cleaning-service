...
> **배치 파일 없이 손으로 하나하나 하고 싶다면** [MANUAL.md](MANUAL.md) 를 보세요.
> 설치·실행·백업·복구·문제해결 명령이 한 줄씩 적혀 있습니다.
>
> **이미 설치된 것을 새 버전으로 고칠 때(패치)는** [PATCH.md](PATCH.md) 를 보세요.
> class 부분 교체·운영 DB 직접 ALTER 는 이제 쓰지 않습니다(WAR 통째 교체 + Flyway 마이그레이션).
